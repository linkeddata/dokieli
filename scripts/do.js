...
var DO = {
    C: {
        ...
        CitationOptions: [
            ...
            '<option value="http://purl.org/spar/cito/citesAsAuthority">cites as authority</option>',
            '<option value="http://purl.org/spar/cito/citesAsDataSource">cites as data source</option>',
            '<option value="http://purl.org/spar/cito/citesAsEvidence">cites as evidence</option>',
            '<option value="http://purl.org/spar/cito/citesAsMetadataDocument">cites as metadata document</option>',
            '<option value="http://purl.org/spar/cito/citesAsPotentialSolution">cites as potential solution</option>',
            '<option value="http://purl.org/spar/cito/citesAsRecommendedReading">cites as potential reading</option>',
            '<option value="http://purl.org/spar/cito/citesAsRelated">cites as related</option>',
            '<option value="http://purl.org/spar/cito/citesAsSourceDocument">cites as source document</option>',
            '<option value="http://purl.org/spar/cito/citesForInformation">cites for information</option>',
            '<option value="http://purl.org/spar/cito/compiles">compiles</option>',
            '<option value="http://purl.org/spar/cito/confirms">confirms</option>',
            '<option value="http://purl.org/spar/cito/containsAssertionFrom">contains assertion from</option>',
            '<option value="http://purl.org/spar/cito/corrects">corrects</option>',
            '<option value="http://purl.org/spar/cito/credits">credits</option>',
            '<option value="http://purl.org/spar/cito/critiques">critiques</option>',
            '<option value="http://purl.org/spar/cito/derides">derides</option>',
            '<option value="http://purl.org/spar/cito/describes">desribes</option>',
            '<option value="http://purl.org/spar/cito/disagreesWith">disagrees with</option>',
            '<option value="http://purl.org/spar/cito/discusses">discusses</option>',
            '<option value="http://purl.org/spar/cito/disputes">disputes</option>',
            '<option value="http://purl.org/spar/cito/documents">documents</option>',
            '<option value="http://purl.org/spar/cito/extends">extends</option>',
            '<option value="http://purl.org/spar/cito/includesExcerptFrom">includes excerpt from</option>',
            '<option value="http://purl.org/spar/cito/includesQuotationFrom">includes quotation from</option>',
            '<option value="http://purl.org/spar/cito/obtainsBackgroundFrom">obtains background from</option>',
            '<option value="http://purl.org/spar/cito/obtainsSupportFrom">obtains support from</option>',
            '<option value="http://purl.org/spar/cito/parodies">parodies</option>',
            '<option value="http://purl.org/spar/cito/plagiarizes">plagiarizes</option>',
            '<option value="http://purl.org/spar/cito/qualifies">qualifies</option>',
            '<option value="http://purl.org/spar/cito/refutes">refutes</option>',
            '<option value="http://purl.org/spar/cito/repliesTo">replies to</option>',
            '<option value="http://purl.org/spar/cito/retracts">retracts</option>',
            '<option value="http://purl.org/spar/cito/reviews">reviews</option>',
            '<option value="http://purl.org/spar/cito/ridicules">ridicules</option>',
            '<option value="http://purl.org/spar/cito/speculatesOn">speculates on</option>',
            '<option value="http://purl.org/spar/cito/supports">supports</option>',
            '<option value="http://purl.org/spar/cito/updates">updates</option>',
            '<option value="http://purl.org/spar/cito/usesConclusionsFrom">uses conclusions from</option>',
            '<option value="http://purl.org/spar/cito/usesDataFrom">uses data from</option>',
