...
var DO = {
    C: {
        ...
        CitationOptions: [
            ...
            '<option value="http://purl.org/spar/cito/citesAsEvidence">as evidence</option>',
            '<option value="http://purl.org/spar/cito/citesAsMetadataDocument">as metadata document</option>',
            '<option value="http://purl.org/spar/cito/citesAsPotentialSolution">as potential solution</option>',
            '<option value="http://purl.org/spar/cito/citesAsRecommendedReading">as potential reading</option>',
            '<option value="http://purl.org/spar/cito/citesAsRelated">as related</option>',
            '<option value="http://purl.org/spar/cito/citesAsSourceDocument">as source document</option>',
