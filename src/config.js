...
module.exports = {
  ...
  DOMNormalisation: {
    'selfClosing': ['area', 'base', 'basefont', 'br', 'circle', 'col', 'colgroup', 'ellipse', 'embed', 'hr', 'img', 'input', 'isindex', 'line', 'link', 'meta', 'metadata', 'param', 'path', 'polygon', 'polyline', 'rect', 'source', 'use', 'wbr'],
