 ...
 */
 ...
 // eventually isolate these functions and use within dokieli.js instead of duplicating
 ...
 // not a fan of this
 document.getElementById("graph-view-container").appendChild(util.fragmentFromString('<aside id="graph-view-aside" class="do on"></aside>'));
 ...
 if (DO.C.GraphViewerAvailable) {
     ...
     if (g) {
         ...
         DO.U.showGraph([docURI], '#graph-view-aside', options);
     }
 }
